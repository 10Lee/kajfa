                    ...
                    <form action="{{ route('register') }}" method="POST" role="form">
                        ...
                        <div class="field">
                            ...
                            @if($errors->has('password_confirm'))
                                <p class="help is-success">{{ $errors->first('password-confirm') }}</p>
                            @endif
                        </div>

                        <button class="button is-success is-outlined is-fullwidth m-t-50">Reset Password</button>
                    </form> 

                </div>
            </div>
    
            <h5 class="has-text-centered m-t-20"><a class="is-muted" href="{{ route('register') }}">Belum punya akun ?</a></h5>
